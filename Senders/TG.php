...
class TG
{
    ...
    public static function sendMessage(
        ...
        $send_result = self::sender($method, $send_data);
    ...
    public static function answerCallbackQuery(float $callback_query_id, string $message): array
    {
        ...
        return self::sender($method, $send_data);
    }
    ...
    public static function setWebhook(): array
    {
        ...
        $parameters = [
            'url' => DB::get__bot_url() . '/index.php?' . $secret_key_name . "=" . $secret_key,
            'max_connections' => 100,
            'allowed_updates' => [
                'message',
                'edited_message',
    ...
    private static function sender(string $method, array $send_data): array
    {
        ...
        curl_setopt_array(
            ...
            [
                ...
                CURLOPT_URL => 'https://api.telegram.org/bot' . DB::get__bot_token() . '/' . $method,
