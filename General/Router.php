...
use dev_bots_ru\Common\Queries;
...
class Router
{
    ...
    public static function set__handler()
    {
        ...
        if ($action_data) :
            DB::add__user_action($action_data);
        endif;
    }
     ...
     * 
     * В Queries строка разбирается из start?param1=val1&param2=val2 в массив [file=>start, param1=>val1, param2=val2]
    ...
    public static function run()
    {
        ...
        self::$parameters = Queries::actions__string_to_array(DB::get__user_action());
